...
public class PluggableService {
    ...
    public static void setServiceProvider(PluginServiceLoader pluginServiceLoader) {
        PluggableService.pluginServiceLoader = pluginServiceLoader;
    }
    ...
    public static <S> ServiceLoader<S> loader(Class<S> service) {
        if (PluggableService.pluginServiceLoader == null) {
        ...
        if (PluggableService.pluginServiceLoader.ensureUses(service)) {
            LOG.info("Adding uses {} to : PluggableService.pluginServiceLoader.", service.getName());
        }
        return PluggableService.pluginServiceLoader.loader(service);
    }
}
